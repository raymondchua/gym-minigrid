...
X, Y = np.meshgrid(x, y)
# Z = f(X, Y)
# folder_dir = '/Users/raymondchua/Documents/gym-minigrid/Q_learning_np_values/'
folder_dir = '/Users/raymondchua/Documents/gym-minigrid/Benna_fusi_model/v4_grid_7/'
# _, _, filenames = next(walk(folder_dir))
...
for i in range(0,5000,10):
	...
	#plot u_1
	file_u1 = folder_dir+'Q_u1_'+str(i)+'.npy'
	temp_u1 = jnp.load(file_u1)
	temp_u1 = np.max(temp_u1, axis=1)
	temp_u1 = temp_u1.reshape((7,7))
	...
	#plot u_2
	file_u2 = folder_dir+'Q_u2_'+str(i)+'.npy'
	temp_u2 = jnp.load(file_u2)
	temp_u2 = np.max(temp_u2, axis=1)
	temp_u2 = temp_u2.reshape((7,7))
	...
	# break
	plot_filename = folder_dir+'V_3d_v4_'+str(i)
