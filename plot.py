...
# q_learning_filename = '/Users/raymondchua/Documents/gym-minigrid/storage/MiniGrid-ClassicGridWorldS7-v0_Q-learning_seed0_21-01-12-15-45-37/log.csv'
# benna_fusi_model_filename = '/Users/raymondchua/Documents/gym-minigrid/storage/MiniGrid-ClassicGridWorldS7-v0_Benna-Fusi_model_Q-learning_seed0_21-01-12-13-43-52/log.csv'
...
dataset = pd.DataFrame({'Benna-Fusi Model': BF_avg_return, 'Q-learning':q_avg_return})
# print(len(BF_avg_return))
...
# ax.set_ylabel('Time to learn good policy (Num of timesteps)')
